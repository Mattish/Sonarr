...
const mapDispatchToProps = {
  ...
  dispatchFetchManualMappings: fetchManualMappings,
};
...
class SignalRConnector extends Component {
  ...
  handleExtrasManualmapping = () => {
    this.props.dispatchFetchManualMappings();
  }
...
SignalRConnector.propTypes = {
  ...
  dispatchFetchManualMappings: PropTypes.func.isRequired
};
